...
export const models: Model[] = [
  {
    ...
    classNames: ['person', 'vehicle', 'bicycle', 'fire', 'smoke'],
    numClasses: 5,
    parsedStatus: 'parsed',
    deployments: [
      { id: 'd1', nodeId: 'n1', nodeName: 'GPU-Server-01', device: 'cuda', deviceName: 'NVIDIA GeForce RTX 3090', status: 'loaded', deployedAt: '2023-10-24T14:30:00' },
    ],
    confidenceThreshold: 0.65, inputResolution: '640x640',
    taskType: 'detect',
  ...
  },
  {
    ...
    classNames: ['normal', 'defect_crack', 'defect_scratch', 'defect_stain'],
    numClasses: 4,
    parsedStatus: 'parsed',
    deployments: [],
    confidenceThreshold: 0.70, inputResolution: '224x224',
    taskType: 'classify',
  ...
  },
  {
    ...
    classNames: ['face', 'mask', 'helmet'],
    numClasses: 3,
    parsedStatus: 'parsed',
    deployments: [
      { id: 'd2', nodeId: 'n1', nodeName: 'GPU-Server-01', device: 'cuda', deviceName: 'NVIDIA GeForce RTX 3090', status: 'loaded', deployedAt: '2023-11-01T16:10:00' },
      { id: 'd3', nodeId: 'n2', nodeName: 'GPU-Server-02', device: 'cuda', deviceName: 'NVIDIA A100', status: 'loaded', deployedAt: '2023-11-02T09:00:00' },
    ],
    confidenceThreshold: 0.80, inputResolution: '160x160',
    taskType: 'detect',
